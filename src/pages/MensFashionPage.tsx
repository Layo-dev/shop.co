...
const MensFashionPage = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Breadcrumb */}
        <Breadcrumb category="Men's Fashion" className="mx-0 px-[16px] my-[20px]" />
        ...
        <section className="hero-gradient py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto mb-8">
              Discover our curated collection of men's clothing, from casual wear to formal attire. 
              Find the perfect pieces to elevate your wardrobe.
            </p>
          </div>
        </section>
