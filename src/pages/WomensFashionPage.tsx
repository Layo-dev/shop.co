...
const WomensFashionPage = () => {
  ...
  const subcategories = [
    'Dresses', 'Tops', 'Blouses', 'Jeans', 'Skirts', 'Trousers', 
    'Blazers', 'Jackets', 'Sweaters', 'Hoodies', 'Shorts', 'Heels', 
    'Flats', 'Bags', 'Accessories', 'Jewelry'
  ];
  ...
  const breadcrumbItems = [
    ...
    { label: "Women's Fashion", href: '/womens' }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Breadcrumb */}
        <Breadcrumb category="Women's Fashion" />
